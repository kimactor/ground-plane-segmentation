...
private:
	...
	inline void loadTimestamps()
	{
		ParameterReader pd;
		std::ifstream tr;
		// std::string timesFile = path.substr(0,path.find_last_of('/')) + "/rgb.txt"; // MonoVo dataset
		std::string timesFile = pd.getData("filename") + pd.getData("timesFile");
		// std::string timesFile = "/home/kim/Dataset/Dataset_from_TUM/ALL_dataset/fr2_desk_person/rgb.txt"; //Tum dataset
